...
6. [ ] 파일 메타데이터 구조 정리  
      상태: 📌 방향 제시 / 마감일: 완료 / 담당: ET / LT
7. [ ] 트리 프리셋 적용 방식  
      상태: 📌 방향 제시 / 마감일: - / 담당: UX팀
8. [ ] 액션 트리 + 기능 트리 통합  
      상태: ✅ 확정 / 마감일: 5/20 / 담당: FE 리드
9. [x] Excluded 기능 목록 정리  
      상태: ✅ 확정 / 마감일: 5/11 / 담당: PM팀
10. [ ] Dual Monitor 지원 기획  
      상태: 📌 방향 제시 / 마감일: 6/07 / 담당: UX팀
11. [ ] 패키지 공유 구조 (씬+썸네일)  
      상태: ✅ 확정 / 마감일: 완료 / 담당: 기획팀
...
13. [x] 퍼블릭 URL 구조 설계 ✅ 2025-05-09
      상태: ⏳ 미정 / 마감일: 기술 논의 필요 / 담당: 개발팀
14. [ ] 퍼블릭 URL 라이선스 처리  
      상태: ✅ 필요 / 마감일: 6월 전 / 담당: 기획 + 라이선스팀
15. [ ] 결제 화면 설계  
      상태: 🔧 진행 중 / 마감일: 6월 말 / 담당: 기획 + 라이선스팀

### 🔹 시스템 구조 / 개발

16. [ ] Space2D3D 개선 회의  
      상태: ❓ 미정 / 마감일: 5/14 / 담당: PM팀
17. [ ] Postgre Self-Hosted 테스트  
      상태: ✅ 확정 / 마감일: 5/26 / 담당: BE 리드
18. [ ] Grid 리팩토링  
      상태: 🔧 진행 중 / 마감일: 5/22 / 담당: BE 리드
...
21. [x] Power BI 내부망 연동  
      상태: ✅ 확정 / 마감일: 완료 / 담당: -
22. [ ] 설치파일 배포 형식 (MSI)  
      상태: ✅ 확정 / 마감일: 완료 / 담당: DevOps
23. [ ] 설치파일 배포 일정  
      상태: 🎯 목표설정 / 마감일: 6월 1주차 / 담당: Dev 팀
24. [ ] OTA 기능 여부  
      상태: ⏳ 보류 / 마감일: - / 담당: -
25. [ ] AWS / Azure 서버 설치 테스트  
      상태: ⏳ 예정 / 마감일: 5월 말까지 / 담당: Infra팀

### 🔹 일정 / 운영

26. [ ] Dev Master Schedule 작성  
      상태: 📆 예정 / 마감일: 5월 3주차 / 담당: Dev 리드
27. [ ] SME 고객 대응 옵션 정리  
      상태: ❓ 논의 필요 / 마감일: - / 담당: 사업팀
28. [x] 담당자 분배 완료  
      상태: ✅ 완료 / 마감일: 완료 / 담당: 준우 프로 중심
