...
| 7   | 파일 리스트 리팩토링              | 🔧 진행 중  | ~5/31     | 김준우        | [ ]  |
| 8   | 파일 메타데이터 구조 정리           | 📌 방향 제시 | 완료        | ET / LT    | [ ]  |
| 9   | 트리 프리셋 적용 방식             | 📌 방향 제시 | -         | UX팀        | [ ]  |
| 10  | 액션 트리 + 기능 트리 통합         | ✅ 확정     | 5/20      | FE 리드      | [ ]  |
| 11  | Space2D3D 개선 회의          | ❓ 미정     | 5/14      | PM팀        | [ ]  |
| 12  | Postgre Self-Hosted 테스트  | ✅ 확정     | 5/26      | BE 리드      | [ ]  |
| 13  | Grid 리팩토링                | 🔧 진행 중  | 5/22      | BE 리드      | [ ]  |
| 14  | Studio Geo/Data 분리       | ✅ 확정     | 완료        | -          | [x]  |
| 15  | 로그인 후 화면 수정              | ✅ 확정     | 완료        | -          | [x]  |
| 16  | Power BI 내부망 연동          | ✅ 확정     | 완료        | -          | [x]  |
| 17  | 설치파일 배포 형식 (MSI)         | ✅ 확정     | 완료        | DevOps     | [ ]  |
| 18  | 설치파일 배포 일정               | 🎯 목표설정  | 6월 1주차    | Dev 팀      | [ ]  |
| 19  | Dev Master Schedule 작성   | 📆 예정    | 5월 3주차    | Dev 리드     | [ ]  |
| 20  | Excluded 기능 목록 정리        | ✅ 확정     | 5/11      | PM팀        | [x]  |
| 21  | Dual Monitor 지원 기획       | 📌 방향 제시 | 6/07      | UX팀        | [ ]  |
| 22  | 결제 화면 설계                 | 🔧 진행 중  | 6월 말      | 기획 + 라이선스팀 | [ ]  |
| 23  | 패키지 공유 구조 (씬+썸네일)        | ✅ 확정     | 완료        | 기획팀        | [ ]  |
| 24  | 중간 제품(설치형 Web) 대응        | ✅ 확정     | 완료        | -          | [x]  |
| 25  | OTA 기능 여부                | ⏳ 보류     | -         | -          | [ ]  |
| 26  | SME 고객 대응 옵션 정리          | ❓ 논의 필요  | -         | 사업팀        | [ ]  |
